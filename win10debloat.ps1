...
$origin.Add_Click({
    Write-Host "Installing EA Origin"
    $ResultText.text = "`r`n" +"`r`n" + "Installing EA Origin... Please Wait" 
    winget install -e ElectronicArts.Origin | Out-Host
    if($?) { Write-Host "Installed EA Origin" }
    $ResultText.text = "`r`n" + "Finished Installing EA Origin" + "`r`n" + "`r`n" + "Ready for Next Task"
})
...
$epic.Add_Click({
    ...
    $ResultText.text = "`r`n" +"`r`n" + "Installing Epic Games... Please Wait" 
...
$Panel1.controls.AddRange(@($brave,$firefox,$7zip,$adobereade,$gchrome,$vlc,$powertoys,$winterminal,$vscode,$Label2,$gimp,$Label7,$Label8,$Label9,$advancedipscanner,$putty,$etcher,$githubdesktop,$cpuZ,$gpuZ,$hwinfotool,$CrystalDiskInfo,$spotify,$crystaldiskmark,$revouninstaller,$nvcleanstall,$malwarebytes,$steam,$origin,$rockstar,$epic))
